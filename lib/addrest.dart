...
import 'package:flutter_application_1/editrest.dart';
import 'package:get/get.dart';

class AddRest extends StatefulWidget {
  @override
  _AddRest createState() => _AddRest();
}

class _AddRest extends State<AddRest> {
        ...
        child: GestureDetector(
          child: ListView(
            children: [
                    ...
                    Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                fit: BoxFit.cover,
                                // image: image != null ? Image.file(image) :AssetImage('assets/person.png')
              ...
              buildTextField("Governorate", "Damascus"),
              buildTextField("Phone", "099999999"),
              buildTextField("Stars", "Five Stars"),
